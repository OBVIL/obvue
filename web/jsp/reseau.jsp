...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=hrefHome%>static/obvie.css" />
    <script src="<%=hrefHome%>static/vendor/sigma/sigma.min.js"></script>
    <script src="<%=hrefHome%>static/vendor/sigma/sigma.plugins.dragNodes.js"></script>
    ...
    <script src="<%=hrefHome%>static/vendor/sigma/sigma.layout.fruchtermanReingold.js"></script>
...
for (Node node : nodeMap.values()) {
  ...
  else if (Tag.VERB.sameParent(tag)) color = "rgba(128, 0, 0, 0.7)";
