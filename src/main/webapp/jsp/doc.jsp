...
String title = "";
if (doc != null) {
    title = ML.detag(doc.doc().get("bibl"));
}
    ...
    <main>
        <form id="qform" action="#">
            ...
            if (topDocs != null && start > 1) {
                out.println("<button name=\"prev\" type=\"submit\" onclick=\"this.form['start'].value=" + (start - 1)
                        + "\">◀</button>");
            }
            %>
            <select name="sort"
            ...
            if (topDocs != null) {
                ...
                if (start < max) {
                    out.println("<button name=\"next\" type=\"submit\" onclick=\"this.form['start'].value=" + (start + 1)
                            + "\">▶</button>");
                }
            }
            %>
